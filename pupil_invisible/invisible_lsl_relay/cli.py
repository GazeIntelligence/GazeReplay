...
async def main_async(time_sync_interval: int = 60, timeout: int = 10, selected_device_info = None):
    """
    ...
    """
    print("stream lsl")
    adapter = relay.Relay(selected_device_info)
